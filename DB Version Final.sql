...
-- Volcando estructura de base de datos para comunidad_ecommerce
CREATE DATABASE IF NOT EXISTS `comunidad_ecommerce` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `comunidad_ecommerce`;

-- Volcando estructura para tabla comunidad_ecommerce.categoria
...
-- Volcando estructura para tabla comunidad_ecommerce.compra
...
-- Volcando estructura para tabla comunidad_ecommerce.comunidad
...
-- Volcando estructura para tabla comunidad_ecommerce.contenido_pagina
...
-- Volcando estructura para tabla comunidad_ecommerce.detalle_compra
...
-- Volcando estructura para tabla comunidad_ecommerce.envio
...
-- Volcando estructura para tabla comunidad_ecommerce.pago
...
-- Volcando estructura para tabla comunidad_ecommerce.producto
...
-- Volcando estructura para tabla comunidad_ecommerce.producto_categoria
...
-- Volcando estructura para tabla comunidad_ecommerce.rol
...
-- Volcando estructura para tabla comunidad_ecommerce.tiene_producto
...
-- Volcando estructura para tabla comunidad_ecommerce.transporte
...
-- Volcando estructura para tabla comunidad_ecommerce.usuario
...
-- Volcando estructura para tabla comunidad_ecommerce.valoracion
